...
children.push(new Paragraph({
  ...
  alignment: AlignmentType.CENTER,
  children: [new TextRun({
    text: "Working draft v8, August 2026. Comments welcome. Please do not cite without permission.",
...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync("/home/user/paper/capitulation_draft_v8.docx", buf);
