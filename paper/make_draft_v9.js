// Capitulation paper, draft v9. Adds the out-of-sample extension to mid-2026
...
children.push(new Paragraph({
  ...
  alignment: AlignmentType.CENTER,
  children: [new TextRun({
    text: "Working draft v9, August 2026. Comments welcome. Please do not cite without permission.",
...
children.push(table(
  ...
  [
    ...
    ["Extension instrument differs from ND", "Seam validation r 0.97; placebo boundaries", "Extension (6.1)", "Validated"],
  ]));
children.push(caption(
...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync("/home/user/paper/capitulation_draft_v9.docx", buf);
